...
contract ERC1155G is ERC1155I, Ownable, Minterable, Burnerable {
    
    ///// Set the name and symbol of ERC1155I ///
    constructor(string memory name_, string memory symbol_) ERC1155I(name_, symbol_) {}
    ...
    function safeBatchTransferFrom(address from_, address to_, uint256[] calldata ids_,
    uint256[] calldata amounts_, bytes memory data_) public override {
        require(_isSameLength(ids_.length, amounts_.length),
